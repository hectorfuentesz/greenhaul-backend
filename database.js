...
const createTableQueryAddresses = `
  CREATE TABLE IF NOT EXISTS addresses (
    ...
    latitude NUMERIC(10, 7),      -- Latitud de la ubicación geográfica (precisión 7 decimales para mapas)
    longitude NUMERIC(10, 7),     -- Longitud de la ubicación geográfica (precisión 7 decimales para mapas)
...
// Se ha añadido la columna 'status' para rastrear el estado del pedido.
...
async function connectAndSetupDatabase() {
  try {
    ...
    // ATENCIÓN: Si ya tenías tu base de datos creada en Railway SIN las nuevas columnas
    // (name, neighborhood, "references", latitude, longitude en 'addresses', y status en 'orders'),
    // los comandos CREATE TABLE IF NOT EXISTS NO las añadirán automáticamente.
    // Necesitas ejecutar manualmente los comandos ALTER TABLE en tu consola SQL de Railway
    // o en tu herramienta de gestión de bases de datos.
    // Aquí están los comandos ALTER TABLE que podrías necesitar ejecutar:
    /*
    ...
    ALTER TABLE addresses ADD COLUMN IF NOT EXISTS "references" TEXT; -- ¡Importante: con comillas dobles!
